...
import fr.oxodao.overcraft.items.PokeballItem;
...
public class Registration {
    ...
    private static final DeferredRegister<BlockEntityType<?>> TILES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, Overcraft.MOD_ID);
    ...
    public static final RegistryObject<Item> POKEBALL_ITEM = ITEMS.register("pokeball", PokeballItem::new);
